...
tests/CMakeFiles/test-model-load-cancel.dir/test-model-load-cancel.cpp.o: /workspace/llama.cpp/tests/test-model-load-cancel.cpp
tests/CMakeFiles/test-model-load-cancel.dir/test-model-load-cancel.cpp.o: tests/CMakeFiles/test-model-load-cancel.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/workspace/llama.cpp/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tests/CMakeFiles/test-model-load-cancel.dir/test-model-load-cancel.cpp.o"
	cd /workspace/llama.cpp/build/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT tests/CMakeFiles/test-model-load-cancel.dir/test-model-load-cancel.cpp.o -MF CMakeFiles/test-model-load-cancel.dir/test-model-load-cancel.cpp.o.d -o CMakeFiles/test-model-load-cancel.dir/test-model-load-cancel.cpp.o -c /workspace/llama.cpp/tests/test-model-load-cancel.cpp
...
tests/CMakeFiles/test-model-load-cancel.dir/test-model-load-cancel.cpp.i: cmake_force
	...
	cd /workspace/llama.cpp/build/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /workspace/llama.cpp/tests/test-model-load-cancel.cpp > CMakeFiles/test-model-load-cancel.dir/test-model-load-cancel.cpp.i
...
tests/CMakeFiles/test-model-load-cancel.dir/test-model-load-cancel.cpp.s: cmake_force
	...
	cd /workspace/llama.cpp/build/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /workspace/llama.cpp/tests/test-model-load-cancel.cpp -o CMakeFiles/test-model-load-cancel.dir/test-model-load-cancel.cpp.s

tests/CMakeFiles/test-model-load-cancel.dir/get-model.cpp.o: tests/CMakeFiles/test-model-load-cancel.dir/flags.make
tests/CMakeFiles/test-model-load-cancel.dir/get-model.cpp.o: /workspace/llama.cpp/tests/get-model.cpp
tests/CMakeFiles/test-model-load-cancel.dir/get-model.cpp.o: tests/CMakeFiles/test-model-load-cancel.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/workspace/llama.cpp/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object tests/CMakeFiles/test-model-load-cancel.dir/get-model.cpp.o"
...
tests/CMakeFiles/test-model-load-cancel.dir/get-model.cpp.i: cmake_force
	...
	cd /workspace/llama.cpp/build/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /workspace/llama.cpp/tests/get-model.cpp > CMakeFiles/test-model-load-cancel.dir/get-model.cpp.i
...
tests/CMakeFiles/test-model-load-cancel.dir/get-model.cpp.s: cmake_force
	...
	cd /workspace/llama.cpp/build/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /workspace/llama.cpp/tests/get-model.cpp -o CMakeFiles/test-model-load-cancel.dir/get-model.cpp.s
...
bin/test-model-load-cancel: /usr/lib64/libcurl.so
...
bin/test-model-load-cancel: tests/CMakeFiles/test-model-load-cancel.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/workspace/llama.cpp/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX executable ../bin/test-model-load-cancel"
	cd /workspace/llama.cpp/build/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-model-load-cancel.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/test-model-load-cancel.dir/clean:
	cd /workspace/llama.cpp/build/tests && $(CMAKE_COMMAND) -P CMakeFiles/test-model-load-cancel.dir/cmake_clean.cmake
.PHONY : tests/CMakeFiles/test-model-load-cancel.dir/clean

tests/CMakeFiles/test-model-load-cancel.dir/depend:
	cd /workspace/llama.cpp/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /workspace/llama.cpp /workspace/llama.cpp/tests /workspace/llama.cpp/build /workspace/llama.cpp/build/tests /workspace/llama.cpp/build/tests/CMakeFiles/test-model-load-cancel.dir/DependInfo.cmake --color=$(COLOR)
